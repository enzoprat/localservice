    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a href="tel:+33769108140" className="flex items-center gap-1.5 text-sm font-medium text-stone hover:text-navy">
      ...
      {open && (
        <div className="mx-4 mt-2 rounded-2xl border border-line bg-white p-4 shadow-lg md:hidden">
          <div className="flex flex-col gap-1">
            ...
            <a href="tel:+33769108140" className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-stone-soft hover:bg-sand">
